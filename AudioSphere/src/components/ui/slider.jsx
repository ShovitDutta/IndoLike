...
const Slider = React.forwardRef(({ className, trackClassName, thumbClassName, value: controlledValue, onValueChange, defaultValue = 0, max = 100, step = 1, ...props }, ref) => {
  ...
  }, [isDragging, max, step, controlledValue, onValueChange, handleMouseMove]); // Added handleMouseMove to dependencies

  const handleMouseDown = (e) => {
    setIsDragging(true);
    handleMouseMove(e); // Set initial value on click
  };
    ...
    >
      ...
      >
        ...
        <div
          ...
          onMouseDown={(e) => {
            e.stopPropagation(); // Prevent dragging the track when clicking the thumb
            handleMouseDown(e);
          }}
        />
      </div>
