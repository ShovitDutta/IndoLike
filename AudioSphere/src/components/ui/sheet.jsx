...
const SheetTitle = ({ className, children, ...props }) => <div className={cn("text-lg font-semibold text-foreground", className)} {...props}>{children}</div>;
SheetTitle.displayName = "SheetTitle";

const SheetDescription = ({ className, children, ...props }) => <div className={cn("text-sm text-muted-foreground", className)} {...props}>{children}</div>;
